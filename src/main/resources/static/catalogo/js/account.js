...
async function consultarCuenta() {
    ...
    if(dato !=null){
        const request = await fetch('../usuario/infocliente ', {
            method: 'POST',
        ...
        let infoUsuario = `<p>Nombre: <span>${usuario.usuario.nombres} ${usuario.usuario.apellidos}</span></p>
        <p>Nombre de usuario: <span>${usuario.usuario.nombreUsuario}</span></p>
